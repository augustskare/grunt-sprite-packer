...
SpritePacker.prototype = {
	...
	createCss: function()
	{
		...
		var totalDimensions = '$' + tplData.name + '-dimensions = (' + tplData.width + 'px ' + tplData.height + 'px)';

		fs.writeFile(this.options.destCss, result + totalDimensions, 'utf8', this.createCssDone.bind(this));
	},
